...
export default function SinglePost(){
    ...
    return(
        <main className="bg-blue-200 main-h-screen p-12">
            <article className="container shadow-lg mx-auto bg-blue-100 rounded-lg">
              ...
              <div className="px-16 lg:px-48 py-12 lg:py-20 prose lg:prose-xl max-w-full"><BlockContent blocks={singlePost.body} projectId="qeh2a4n0" dataset="production" /></div>
            </article>
        </main>
    )
}